...
class PairedRead(Read):
    ...
    def __init__(self, line, correct):
        ...
        self.uncapped_map_q, self.xian_cap, self.score_group_map_q, self.adam_cap, self.stage = \
...
def main():
    ...
    def current_cap(r):
        ...
        :return:
        """
        return round(min(r.uncapped_map_q, f(r.xian_cap), f(r.score_group_map_q/2.0), max(r.adam_cap, r.pair.adam_cap), 60))
